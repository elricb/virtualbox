...
const START = {
  compile:  PATHS.app + '/index.jsx',
  server:   PATHS.src + '/server/index.js'
};
...
if(ENV === 'dev') {
    module.exports = merge(common, {
        ...
        watchOptions: {
            poll: 400 //check for file changes every X milliseconds
            //In virtual environments, updated files don't invoke inotify
